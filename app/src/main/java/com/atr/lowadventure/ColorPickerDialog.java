...
public class ColorPickerDialog extends Dialog {
    ...
    public static class ColorPickerView extends View {
        ...
        private int mCurrentX = 0, mCurrentY = 0, buttonSize = 0;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (Color.red(mDefaultColor) + Color.green(mDefaultColor)
                ...
                mPaint.setColor(Color.BLACK);
            canvas.drawText("Отмена", 202, 340,
                    mPaint);
        }
        @Override
    ...
    public ColorPickerDialog(Context context, OnColorChangedListener listener,
                             String key, int initialColor, int defaultColor, int buttonSize) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new ColorPickerView(getContext(), l, mInitialColor,
                mDefaultColor));
        setTitle("Выберите цвет заливки");
